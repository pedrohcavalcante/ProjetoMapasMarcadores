package com.example.androidbti.projetomapasmarcadores;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener, GoogleMap.OnMarkerClickListener, GoogleMap.OnMarkerDragListener {
    ...
    public void onMapClick(LatLng latLng) {
        ...
        options.position(latLng).title("Posicao " + contador)
                .snippet("Detalhes Marcador " + contador)
    ...
    public void onMarkerDragEnd(Marker marker) {
        Toast.makeText(this, "Estou em " + marker.getPosition().toString(), Toast.LENGTH_SHORT).show();
    }
}
